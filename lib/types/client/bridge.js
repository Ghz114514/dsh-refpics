...
export function setSessionsService(service) {
...
export function setBetterSidebarService(service) {
 ...
 */
export async function sendToAgent(sessionId, text) {
 ...
 */
export function openRefpicsBoard(sessionId) {
    ...
    const scope = sessionId === undefined ? undefined : { sessionId };
...
export function boardAvailable() {
